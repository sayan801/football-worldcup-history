<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage4.master" AutoEventWireup="true" CodeFile="people.aspx.cs" Inherits="people" %>
                ...
                <table cellpadding="0" cellspacing="0" class="style1">
                    ...
                    <tr>
                        <td class="style7" colspan="4" style="text-align: center">
                            <span class="style14"><strong>People You May Know</strong><asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                SelectCommand="SELECT [img], [name], [email] FROM [register]">
                            </asp:SqlDataSource>
                            </span>
                            <br />
                        </td>
                    ...
                    <tr>
                        <td class="style7" style="text-align: justify" colspan="4" rowspan="17">
                            ...
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;<span class="style14"><strong><asp:GridView 
                                ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" 
                                BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                                DataKeyNames="email" DataSourceID="SqlDataSource1" GridLines="Vertical" 
                                Width="736px" AllowPaging="True" PageSize="4">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button ID="Button3" runat="server" Height="22px" onclick="Button3_Click" 
                                                style="font-weight: 700; text-decoration: underline; color: #000066; background-color: #33CC33" 
                                                Text="View Profile" Width="150px" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button ID="Button4" runat="server" Height="22px" onclick="Button4_Click" 
                                                style="font-weight: 700; text-decoration: underline; color: #000066; background-color: #33CCFF" 
                                                Text="Send Message" Width="150px" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                    ...
                    <tr>
                        <td class="style10">
                            <asp:HyperLink ID="HyperLink13" runat="server" Height="19px" 
                                NavigateUrl="~/people.aspx" style="font-weight: 700" Width="120px">You may know</asp:HyperLink>
                                </td>
                        <td class="style5">
                            &nbsp;</td>
                    </tr>
