<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage4.master" AutoEventWireup="true" CodeFile="entertain.aspx.cs" Inherits="entertain" %>
...
&nbsp;<asp:HyperLink ID="HyperLink5" runat="server" Height="20px" 
                ...
                <table cellpadding="0" cellspacing="0" class="style1">
                    ...
                    <tr>
                        <td class="style14" colspan="4" style="text-align: center">
                            <strong>Play Games</strong></td>
                    </tr>
                    <tr>
                        <td class="style7" colspan="4">
                            ...
                            <asp:Label ID="Label8" runat="server" 
                                style="z-index: 1; left: 320px; top:235px; position:absolute; width: 602px; height: 469px; margin-top: 0px;">
                            <embed src="games/AdvanceCricket.exe" type="application/x-shockwave-flash" width="600" height="500"></embed></asp:Label>
                        </td>
                    </tr>
                    <tr>
